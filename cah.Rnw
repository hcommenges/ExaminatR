...
<<cah1, echo=FALSE, results='markup', dev="my_png", fig.ext="png", fig.pos="H", warning=FALSE, message=FALSE, cache=FALSE>>=
cahResults <- ComputeClassif(df = readData(), varquanti = input$varcah)
print(PlotDendro(cahResults))
print(PlotHeight(cahResults))
@

<<cah2, echo=FALSE, results='markup', dev="my_png", fig.ext="png", fig.pos="H", warning=FALSE, message=FALSE, cache=FALSE>>=
